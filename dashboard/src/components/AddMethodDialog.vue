			...
			<div v-else-if="stripeMode" class="space-y-3">
				...
				<p class="text-p-sm text-ink-gray-5">
					<template v-if="stripeSubmitting">
						Validating your card with a small temporary charge that's refunded right
						away. This can take a few seconds — please don't close this window.
					</template>
					<template v-else>
