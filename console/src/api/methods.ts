...
export const API = {
  ...
  migrateServer: 'central.api.migrations.migrate_server',
  cancelMigration: 'central.api.migrations.cancel_migration',
  listMigrations: 'central.api.migrations.list_migrations',
