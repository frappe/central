...
from central.infrastructure.doctype.region.atlas_connection import AtlasConnectionMixin
from central.infrastructure.doctype.region.cargo_connection import CargoConnectionMixin
