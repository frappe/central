		...
		fields: [
			{
				...
				options: "Region",
				label: __("Region"),
				description: __("Blank = global rate (every region). Else pick one. Re-run per region."),
			},
		...
		fields: [
			{
				...
				options: "Region",
				label: __("Region"),
				description: __("Blank = global rate (every region). Else price one region. Re-run per region."),
			},
		],
