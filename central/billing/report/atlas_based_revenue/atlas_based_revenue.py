...
A Virtual Machine's `region` identifies the Atlas instance it runs on. Billing copies
that value into its cluster dimension, so grouping line-item revenue by cluster is revenue-by-Atlas. One
